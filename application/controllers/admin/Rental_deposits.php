...
/**
 * Controlador puente para exponer /admin/rental_deposits sin depender del cargador de rutas del módulo.
 * Mantiene la lógica dentro de modelos/vistas del módulo Rentals y evita tocar controladores core existentes.
 */
class Rental_deposits extends AdminController
{
    protected $permission = 'rentals_deposits';
    protected $model_name = 'Rental_deposits_model';
    protected $view_folder = 'deposits';
    protected $lang_key = 'rental_deposits';
    protected $route = 'rental_deposits';
    ...
    public function form($id = '')
    {
        ...
        $this->load->view('rentals/' . $this->view_folder . '/deposit', $data);
    }
