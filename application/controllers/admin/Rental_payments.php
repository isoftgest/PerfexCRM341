...
/**
 * Controlador puente para exponer /admin/rental_payments sin depender del cargador de rutas del módulo.
 * Mantiene la lógica dentro de modelos/vistas del módulo Rentals y evita tocar controladores core existentes.
 */
class Rental_payments extends AdminController
{
    protected $permission = 'rentals_payments';
    protected $model_name = 'Rental_payments_model';
    protected $view_folder = 'payments';
    protected $lang_key = 'rental_payments';
    protected $route = 'rental_payments';
    ...
    public function form($id = '')
    {
        ...
        $this->load->view('rentals/' . $this->view_folder . '/payment', $data);
    }
