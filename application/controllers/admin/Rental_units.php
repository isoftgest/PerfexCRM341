...
/**
 * Controlador puente para exponer /admin/rental_units sin depender del cargador de rutas del módulo.
 * Mantiene la lógica dentro de modelos/vistas del módulo Rentals y evita tocar controladores core existentes.
 */
class Rental_units extends AdminController
{
    protected $permission = 'rentals_units';
    protected $model_name = 'Rental_units_model';
    protected $view_folder = 'units';
    protected $lang_key = 'rental_units';
    protected $route = 'rental_units';
    ...
    public function form($id = '')
    {
        ...
        $this->load->view('rentals/' . $this->view_folder . '/unit', $data);
    }
