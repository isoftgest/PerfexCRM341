...
class Rental_payments_model extends App_Model
{
    protected $table = 'rental_payments';
    protected $allowed = ['rental_id','clientid','payment_month','due_date','amount','amount_paid','status','payment_date','payment_method','reference','notes'];
