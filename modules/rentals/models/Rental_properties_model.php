...
class Rental_properties_model extends App_Model
{
    protected $table = 'rental_properties';
    protected $allowed = ['name','reference','address','city','province','postal_code','country','owner_name','owner_phone','owner_email','notes','active'];
